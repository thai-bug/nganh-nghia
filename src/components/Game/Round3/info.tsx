...
import { info } from "@/data/round3.json";

const Round3Info = () => {
  return (
    <div className="grid place-items-center my-8">
      <div className=" ">
        <div className=" bg-gradient-to-b from-gray-100 to-gray-200 p-4 rounded-3xl h-[60vh] ">
          <div className="flex justify-between gap-8 items-center h-[50vh]">
            <div className="w-1/3">
